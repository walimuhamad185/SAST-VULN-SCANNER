...
SINKS = {
    ...
    "javascript": [
        ...
        r"Math\.random\s*\(\).*token|Math\.random\s*\(\).*secret|Math\.random\s*\(\).*password",
    ...
    "java": [
        ...
        r"jwt\.sign|SignatureAlgorithm|setAllowed|sendRedirect\s*\([^)]*request",
    ],
    "go": [
    ...
    "c": [
        ...
        r"MD5_Init|SHA1_Init|BIO_new\s*\()",
...
SANITIZERS = {
    "python": [
        r"yaml\.safe_load\s*\(", r"html\.escape\s*\(", r"markupsafe\.escape\s*\(",
        r"subprocess\.run\s*\(\s*\[[^]]*\]\s*,\s*shell\s*=\s*False",
        r"secrets\.token_hex|secrets\.token_urlsafe|secrets\.choice|secrets\.randbelow",
        r"hashlib\.(sha256|sha512|sha3_256|pbkdf2_hmac)|bcrypt\.",
        r"re\.fullmatch|re\.match.*allow|allowlist",
        r"cursor\.execute\s*\([^)]*%s[^)]*,\s*\(|\?\s*,\s*\(",
    ],
    "javascript": [
        r"crypto\.createHash\s*\(\s*['\"]sha256|scrypt|pbkdf2|argon2",
        r"crypto\.randomBytes\s*\(|randomUUID\s*\()",
        r"escape\s*\(|encodeURIComponent\s*\(|he\.encode\s*\()",
        r"exec\s*\(\s*['\"]",
        r"prepare\s*\(|parameterized|\$[0-9]+\s*,",
    ],
    "typescript": [
        r"crypto\.createHash\s*\(\s*['\"]sha256|scrypt|pbkdf2|argon2",
    ...
    "php": [
        ...
        r"hash\s*\(\s*['\"]sha256|password_hash",
    ],
    "ruby": [
    ...
    "java": [
        ...
        r"ESAPI\.encoder|OWASP.*encoder|StringEscapeUtils\.escapeHtml",
    ],
    "go": [
        r"sha256\.New\s*\(|bcrypt\.|argon2\.",
        r"db\.QueryContext\s*\([^)]*\?|db\.ExecContext\s*\([^)]*\?",
        r"html\.EscapeString\s*\(|r\.URL\.Query\(\)\.Get\s*\(\s*['\"]",
    ],
    "c": [
        r"BIO_f_base64|SHA256_Init|openssl/|bcrypt",
        r"snprintf\s*\(",
    ],
    "cpp": [
